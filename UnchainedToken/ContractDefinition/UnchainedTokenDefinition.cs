...
namespace UnchainedBackend.UnchainedToken.ContractDefinition
{
    ...
    public partial class UnchainedTokenDeployment : UnchainedTokenDeploymentBase
    {
        public UnchainedTokenDeployment() : base(BYTECODE) { }
        public UnchainedTokenDeployment(string byteCode) : base(byteCode) { }
    }

    public class UnchainedTokenDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public UnchainedTokenDeploymentBase() : base(BYTECODE) { }
        public UnchainedTokenDeploymentBase(string byteCode) : base(byteCode) { }
